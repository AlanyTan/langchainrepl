...
question = "Research how to calculate SPC study in manufacturing using AIAG guidelines, and write python code to calculate cp, cpk, and pp, ppk using D2 constant"
agent.run(question)
